...
dashboardPage(
  ...
  dashboardHeader(title="Exploring the 1973 US Arrests data with R & Shiny Dashboard", titleWidth = 650, 
                  ...
                  tags$li(class="dropdown",tags$a(href="https://www.linkedin.com/in/akilarasanp-74087121a" ,icon("linkedin"), "My Profile", target="_blank")),
                  tags$li(class="dropdown",tags$a(href="https://github.com/Akilarasan1", icon("github"), "Source Code", target="_blank"))
  ),
